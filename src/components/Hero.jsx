  ...
  return (
    <section id="top" className="relative flex min-h-[100svh] flex-col overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center px-6 pt-28 sm:px-10 sm:pt-32">
        ...
        >
          {shop.tagline} Smash burgers, loaded fries, pasta and paninis — dine-in, drive-through
          or delivered no-contact, {shop.neighborhood}.
        </p>
        ...
        <div className="overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_6%,black_94%,transparent)]">
          <div className="flex w-max animate-marquee gap-10 motion-reduce:animate-none">
            {marqueeWords.map((w, i) => (
              <span key={i} className="flex items-center gap-10 font-display text-lg text-cream-100/80 sm:text-2xl">
                {w}
